...
@ConditionalOnProperty(name = "file.rank.enabled", havingValue = "true", matchIfMissing = false)
@ConfigurationProperties(prefix = "file.rank.redis")
@Configuration
public class FileRankRedissonConfig {
