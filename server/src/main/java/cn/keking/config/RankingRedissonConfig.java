...
@Configuration
public class RankingRedissonConfig {
    ...
    @Bean("rankingRedissonClient")
    @Primary
    public RedissonClient rankingRedissonClient() throws Exception {
        ...
        config.setThreads(thread > 0 ? thread : Runtime.getRuntime().availableProcessors() * 2);
