...
/**
 * 预览排行榜功能的独立Redis配置类
 * 与系统原有的Redis缓存配置完全独立，避免相互影响
 */
@Configuration
@ConfigurationProperties(prefix = "preview.rank.redis")
public class PreviewRankRedisConfig {
    ...
    /**
     * 创建预览排行榜专用的RedissonClient
     * 使用独立的Redis连接配置，不影响系统其他功能
     */
    @Bean(name = "previewRankRedissonClient")
    public RedissonClient previewRankRedissonClient() throws Exception {
